...
#
# After changing volunteer count, auto-dispatches pending tasks to any
# newly available volunteers (critical → low priority order).

from fastapi import APIRouter, HTTPException

from schemas import VolunteerCountRequest
from core import VOLUNTEERS, priority_queue
from core.dispatch_engine import set_volunteer_count, get_volunteer_count, dispatch_all
...
async def update_volunteer_count(body: VolunteerCountRequest):
    ...
    # Auto-dispatch pending tasks to newly available volunteers
